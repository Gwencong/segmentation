...
from utils.utils import colorstr, file_size, set_logging
...
if __name__ == "__main__":
    ...
    try:
        ...
        if isdynamic or opt.dynamic:
            ...
            profile.set_shape("x", (bs, 3, 512, 512), (bs, 3, 720, 1280), (bs, 3, 1280, 1280))
...
# python3 export_TRT.py --onnx weights/deeplabv3p.onnx